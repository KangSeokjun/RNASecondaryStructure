...
with open(os.path.join(save_path, 'redfold_train_split_seed_{}.pickle'.format(random_seed)), "wb") as f:
        cPickle.dump(train_data, f)
print('train pickle generation done')

with open(os.path.join(save_path, 'redfold_val_split_seed_{}.pickle'.format(random_seed)), "wb") as f:
      cPickle.dump(val_data, f)
print('val pickle generation done')

with open(os.path.join(save_path, 'redfold_test_split_seed_{}.pickle'.format(random_seed)), "wb") as f:
